...
```
cd existing_repo
git remote add origin https://gitlab.informatika.org/sivaren/if3210-2023-android-nkr.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.informatika.org/sivaren/if3210-2023-android-nkr/-/settings/integrations)
